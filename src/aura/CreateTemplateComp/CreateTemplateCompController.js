({
    ...
    getSwitchScore: function(component, event, helper) {
        ...
        var qstnId = data.Id;
        var qstnWeight = (data.GKN_FB__Question_Questionnaires__r[0].GKN_FB__Weight__c !==undefined?data.GKN_FB__Question_Questionnaires__r[0].GKN_FB__Weight__c:1);
        var totalpossible = 0.0;
        var totalscore = 0.0;
    ...
    getBranchingSwitchScore: function(component, event, helper) {
        ...
        var qstnWeight = data.GKN_FB__Question_Questionnaires__r[0].branchingQuestnQuetnnaire[branchingindex].GKN_FB__Weight__c;
        var totalpossible = 0.0;
        var totalscore = 0.0;
        var scoreFoundInOptn = false;
        var scoreMap = {
    ...
    setPicklistScore: function(component, event, helper) {
        ...
        for (var i = 0; i < qstnOptionData.length; i++) {
            ...
            if (qstnOptionData[i].Id === selctedOptionId) {
                if (qstnOptionData[i].GKN_FB__Score__c !== undefined) {
                    console.log(qstnOptionData[i].GKN_FB__Score__c+'*ww'+qstnWeight);
