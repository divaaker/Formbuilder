               ...
               // alert($(this).attr('data-qqid')+':::'+$(this).attr('data-qid'));
                ...
                if(oldIndex>newIndex){
                    ...
                    var Obj_Question_QuestionnairesDown = {
                        ...
                        Id: lstQuestn[oldIndex].GKN_FB__Question_Questionnaires__r[0].Id,
                        GKN_FB__Question_Order__c:  newIndex
                    };
                    var qOrder =newIndex;
                    ...
                    if(lstQuestn[oldIndex].GKN_FB__Question_Questionnaires__r[0].branchingQuestnQuetnnaire !== undefined){
                        var branchingQuestnQuetnnaireOldIndex =lstQuestn[oldIndex].GKN_FB__Question_Questionnaires__r[0].branchingQuestnQuetnnaire ;
                        for(var indexSortbranchingQuestnQuetnnaireOld=0; indexSortbranchingQuestnQuetnnaireOld<branchingQuestnQuetnnaireOldIndex.length;indexSortbranchingQuestnQuetnnaireOld++){
                            ...
                            var Obj_Question_QuestionnairesOldNew = {
                                ...
                                GKN_FB__Question_Order__c : qOrder
                            };
                    ...
                    for (var varQuestn = newIndex; varQuestn < lstQuestn.length; varQuestn++) {
                        ...
                        if(lstQuestn[oldIndex].GKN_FB__Question_Questionnaires__r[0].Id !== lstQuestn[varQuestn].GKN_FB__Question_Questionnaires__r[0].Id){
                             qOrder =qOrder+1;
                            var Obj_Question_QuestionnairesNew = {
                                sobjectType: 'Question_Questionnaire__c',
                                Id: lstQuestn[varQuestn].GKN_FB__Question_Questionnaires__r[0].Id,
                                GKN_FB__Question_Order__c: qOrder
                            };
                           
                            lstQuestion_Questionnaires.push(Obj_Question_QuestionnairesNew);
                            var branchingQuestnQuetnnaire =lstQuestn[varQuestn].GKN_FB__Question_Questionnaires__r[0].branchingQuestnQuetnnaire ;
                    ...
                    for (var varUpQuestn = upQOrder; varUpQuestn < lstQuestn.length; varUpQuestn++) {
                        if(lstQuestn[oldIndex].GKN_FB__Question_Questionnaires__r[0].Id !== lstQuestn[varUpQuestn].GKN_FB__Question_Questionnaires__r[0].Id){

                            var Obj_Question_QuestionnairesUp = {
                                sobjectType: 'Question_Questionnaire__c',
                                Id : lstQuestn[varUpQuestn].GKN_FB__Question_Questionnaires__r[0].Id,
                                GKN_FB__Question_Order__c : upQOrder
                            };
                            lstQuestion_Questionnaires.push(Obj_Question_QuestionnairesUp);
                            upQOrder++;
                            var branchingQuestnQuetnnaireUpAndDown =lstQuestn[varUpQuestn].GKN_FB__Question_Questionnaires__r[0].branchingQuestnQuetnnaire ;
                        ...
                        if( lstQuestn[varUpQuestn].GKN_FB__Question_Questionnaires__r[0].Id === lstQuestn[newIndex].GKN_FB__Question_Questionnaires__r[0].Id)
                        {
                            ...
                            upQOrder++;
                            var mainBranchingQQnnaire =lstQuestn[oldIndex].GKN_FB__Question_Questionnaires__r[0].branchingQuestnQuetnnaire ;
                    ...
                    if (lstQDynLogic !== undefined && lstQDynLogic !== null && lstQDynLogic.length > 0) {
                        ...
                        if (isRemove === true) {
                            for (var indexQueResult = 0; indexQueResult < question.length ; indexQueResult++) {
                                ...
                                for (var indexQQnnaire = 0; indexQQnnaire < lst_Question_Questionnaires.length; indexQQnnaire++) {
                                    ...
                                    if (lst_Question_Questionnaires[indexQQnnaire].MainQuestionId === questnId) {
                                            if(question[indexQueResult].GKN_FB__Question_Questionnaires__r[0].branchingQuestnQuetnnaire !== undefined){
                                                ...
                                                lstQuestionsId.push(lst_Question_Questionnaires[indexQQnnaire].Id);
                                                question[indexQueResult].GKN_FB__Question_Questionnaires__r[0].branchingQuestnQuetnnaire = branchingQuestionQuestnnnaireNew;
                                            }
                                    }
                            ...
                            while (!done) {
                                ...
                                for (var i = 1; i < question.length; i += 1) {
                                    if (question[i - 1].GKN_FB__Question_Questionnaires__r[0].GKN_FB__Question_Order__c > question[i].GKN_FB__Question_Questionnaires__r[0].GKN_FB__Question_Order__c) {
                                        done = false;
                        ...
                        while (!doneReuslt) {
                            ...
                            for (var point = 1; point < question.length; point += 1) {
                                if (question[point - 1].GKN_FB__Question_Questionnaires__r[0].GKN_FB__Question_Order__c > question[point].GKN_FB__Question_Questionnaires__r[0].GKN_FB__Question_Order__c) {
                                    doneReuslt = false;
        ...
        action.setCallback(this, function(res) {
            ...
            if (state === "SUCCESS") {
                ...
                if (component.get("v.objQues.GKN_FB__Type__c") === "Date") {
                    ...
                    component.set("v.isShowCheckboxModal", true);
                } else if (component.get("v.objQues.GKN_FB__Type__c") === "Radio") {
                    component.set("v.isShowRadioModal", true);
                }
                    ...
                    component.set("v.isShowSignatureModal", true);
                } else if (component.get("v.objQues.GKN_FB__Type__c") === "Header/Footer") {
                    component.set("v.isShowHeaderModal", true);
                } else {
                    component.set("v.isShowModal", true);
                }
        ...
        if (mainQuestionBranching !== undefined) {
            ...
            if (selctedOptionId !== undefined && selctedOptionId !== null && selctedOptionId.length > 0) {
                ...
                for (var scorebranchgQuestnQnaireIndex = 0; scorebranchgQuestnQnaireIndex < mainQuestionBranching.length; scorebranchgQuestnQnaireIndex++) {
                    lstAddScore.push(mainQuestionBranching[scorebranchgQuestnQnaireIndex].GKN_FB__Question__c);
                }
            }
