({
    ...
    saveQues: function(component, event, helper) {
        ...
        var sobjectName = component.get("v.objCrteQues.GKN_FB__lookup_Object_API_Name__c");
        var sobjectFieldName = component.get("v.objCrteQues.GKN_FB__lookup_Object_Field_Name__c");
    ...
    callObjectField: function(component, event, helper) {
        var vQues = component.get("v.objCrteQues");
        if (vQues.GKN_FB__lookup_Object_API_Name__c !== undefined && vQues.GKN_FB__lookup_Object_API_Name__c !== "" && vQues.GKN_FB__lookup_Object_API_Name__c.length !== 0) {
            helper.helperGetSelectedObjectFields(component, event, vQues.GKN_FB__lookup_Object_API_Name__c);
        }
