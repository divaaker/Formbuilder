({
    ...
    createQuestion: function(component, event, vQnaireId, vSectionId, vDragId, colNumber, lstQuestionOptions) {
        ...
        vQues.GKN_FB__Label__c = this.removePTag(component, event, vQues.GKN_FB__Label__c.trim());
        ...
        if(lstQuestionOptions.length<2){
            this.showToast(component, event, 'Atleast Create 2 options.');
            return false;
        }
