({
    ...
    saveQues: function(component, event, helper) {
        ...
        if (!qustnlabel || qustnlabel.trim().length === 0) {
            ...
            var helpTextValue = component.get("v.objCrteQues.GKN_FB__Help_Text__c");
            if (!helpTextValue) {
        ...
        if (component.get("v.objCrteQues.GKN_FB__Is_Weight_Required__c")) {
            var weightValule = component.get("v.objCrteQues.GKN_FB__Weight__c");
            if (!weightValule) {
    ...
    saveEditQuesrecord: function(component, event, helper) {
        ...
        if (!qustnlabel || qustnlabel.trim().length === 0) {
            ...
            var helpTextValue = component.get("v.objeditQues.GKN_FB__Help_Text__c");
        ...
        if (component.get("v.objeditQues.GKN_FB__Is_Weight_Required__c")) {
            var weightValule = component.get("v.objeditQues.GKN_FB__Weight__c");
        ...
        var lstQuesOptions = component.get("v.objeditQues.GKN_FB__Question_Options__r")
    ...
    editOptionInEdit: function(component, event, helper) {
        ...
        if (data.GKN_FB__Question_Options__r != null) {
            for (var i = 0; i < data.GKN_FB__Question_Options__r.length; i++) {
                if (data.GKN_FB__Question_Options__r[i].Id === optionId) {
                    data.GKN_FB__Question_Options__r[i].isEditOption = true;
                } else {
    ...
    updateEditOptionInEdit: function(component, event, helper) {
        ...
        if (data.GKN_FB__Question_Options__r != null) {
            for (var i = 0; i < data.GKN_FB__Question_Options__r.length; i++) {
                if (data.GKN_FB__Question_Options__r[i].Id === optionId) {
                    helper.updateOptionInEdit(component, event, data.GKN_FB__Question_Options__r[i]);
                }
            }
        }
    },
